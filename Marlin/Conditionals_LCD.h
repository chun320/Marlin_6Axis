 ...
 */
  ...
  #define E_MANUAL        EXTRUDERS
  #define J_STEPPERS      EXTRUDERS
  #define J_MANUAL        EXTRUDERS
  #define H_STEPPERS      EXTRUDERS
  #define H_MANUAL        EXTRUDERS
 ...
 */
  ...
  #define XYZEJH_N XYZEJH
  #if ENABLED(HANGPRINTER)
    #define NUM_AXIS_N ABCDE
  #else
    #define NUM_AXIS_N XYZEJH
  #endif
  #define E_AXIS_N E_AXIS
  #define J_AXIS_N J_AXIS
  #define H_AXIS_N H_AXIS

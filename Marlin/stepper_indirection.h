...
// E0 Stepper
  ...
  #define E0_DIR_READ (stepperE0.getStatus() & STATUS_DIR)
	...
	#define J0_ENABLE_INIT SET_OUTPUT(J_ENABLE_PIN)
	#define J0_ENABLE_WRITE(STATE) WRITE(J_ENABLE_PIN,STATE)
	#define J0_ENABLE_READ READ(J_ENABLE_PIN)

	#define H0_ENABLE_INIT SET_OUTPUT(H_ENABLE_PIN)
	#define H0_ENABLE_WRITE(STATE) WRITE(H_ENABLE_PIN,STATE)
	#define H0_ENABLE_READ READ(H_ENABLE_PIN)
  ...
  #define J0_DIR_INIT SET_OUTPUT(J_DIR_PIN)
  #define J0_DIR_WRITE(STATE) WRITE(J_DIR_PIN,STATE)
  #define J0_DIR_READ READ(J_DIR_PIN)

  #define H0_DIR_INIT SET_OUTPUT(H_DIR_PIN)
  #define H0_DIR_WRITE(STATE) WRITE(H_DIR_PIN,STATE)
  #define H0_DIR_READ READ(H_DIR_PIN)
...
#define J0_STEP_INIT SET_OUTPUT(J_STEP_PIN)
#define J0_STEP_WRITE(STATE) WRITE(J_STEP_PIN,STATE)
#define J0_STEP_READ READ(J_STEP_PIN)

#define H0_STEP_INIT SET_OUTPUT(H_STEP_PIN)
#define H0_STEP_WRITE(STATE) WRITE(H_STEP_PIN,STATE)
#define H0_STEP_READ READ(H_STEP_PIN)
 ...
 */
  ...
  #define J_STEP_WRITE(J,V) J0_STEP_WRITE(V)
  #define   NORM_J_DIR(J)   J0_DIR_WRITE(!INVERT_J0_DIR)
  #define    REV_J_DIR(J)   J0_DIR_WRITE( INVERT_J0_DIR)

  #define H_STEP_WRITE(H,V) H0_STEP_WRITE(V)
  #define   NORM_H_DIR(H)   H0_DIR_WRITE(!INVERT_H0_DIR)
  #define    REV_H_DIR(H)   H0_DIR_WRITE( INVERT_H0_DIR)

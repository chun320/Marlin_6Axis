...
#define ISR_START_H_STEPPER_CYCLES   ISR_START_STEPPER_CYCLES
#define ISR_H_STEPPER_CYCLES         ISR_STEPPER_CYCLES
...
#define MIN_ISR_START_LOOP_CYCLES (ISR_START_X_STEPPER_CYCLES + ISR_START_Y_STEPPER_CYCLES + ISR_START_Z_STEPPER_CYCLES + ISR_START_E_STEPPER_CYCLES+ ISR_START_J_STEPPER_CYCLES+ ISR_START_H_STEPPER_CYCLES + ISR_START_MIXING_STEPPER_CYCLES)

// And the total minimum loop time, not including the base
#define MIN_ISR_LOOP_CYCLES (ISR_X_STEPPER_CYCLES + ISR_Y_STEPPER_CYCLES + ISR_Z_STEPPER_CYCLES + ISR_E_STEPPER_CYCLES + ISR_J_STEPPER_CYCLES + ISR_H_STEPPER_CYCLES + ISR_MIXING_STEPPER_CYCLES)

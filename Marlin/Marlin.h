...
extern const char axis_codes[XYZEJH];
  ...
  #if HAS_J_ENABLE
	#define  enable_J0() J0_ENABLE_WRITE( J_ENABLE_ON)
	#define disable_J0() J0_ENABLE_WRITE(!J_ENABLE_ON)
	#else
	#define  enable_J0() NOOP
	#define disable_J0() NOOP
  #endif

  #if HAS_H_ENABLE
	#define  enable_H0() H0_ENABLE_WRITE( H_ENABLE_ON)
	#define disable_H0() H0_ENABLE_WRITE(!H_ENABLE_ON)
	#else
	#define  enable_H0() NOOP
	#define disable_H0() NOOP
  #endif
...
void sync_plan_position_j();
void sync_plan_position_h();
...
extern bool axis_relative_modes[XYZEJH];
...
extern float current_position[XYZEJH], destination[XYZEJH];

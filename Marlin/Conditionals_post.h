...
#ifndef DISABLE_INACTIVE_H
#define DISABLE_INACTIVE_H DISABLE_H
#endif
...
#define HAS_H_ENABLE     (PIN_EXISTS(H_ENABLE))
#define HAS_H_DIR        (PIN_EXISTS(H_DIR))
#define HAS_H_STEP       (PIN_EXISTS(H_STEP))
#define HAS_H_MICROSTEPS (PIN_EXISTS(H_MS1))
